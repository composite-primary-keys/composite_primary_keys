...
If you are using Rails (ie, wiht bundler), add the following to your Gemfile:
...
is also a Google group, but you'll have better luck getting support using GitHub.
